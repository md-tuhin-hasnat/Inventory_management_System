...
Project Description :
    ...
    It is a very simple store management system that have these
functionality,
    (i)     Adding product
    (ii)    Selling product
    (iii)   Displaying sold product
    (iv)    Displaying unsold product
    (v)     Exiting Program

Group Member :
                Name                    ID
    (i)     MD Tuhin Hasnat         21225103379
    (ii)    Abidur Rahman           21225103388
    (iii)   Zarin Aysha             21225103402
    (iv)    Rakibul Islam Rifat
**---------------------------------------------------------------**/
